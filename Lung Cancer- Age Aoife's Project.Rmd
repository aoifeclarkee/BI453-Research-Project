...
print(unique(sample_metadata$`age:ch1`))  
```
...
```
```{r}
# Create a model matrix for differential expression analysis
...
# Re-check if there are still NA values in predictions
